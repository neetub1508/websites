...
// the 1099estimator AdSense account, leave ADSENSE_CLIENT empty: the <head> loader
...
// ============================================================================
export const ADSENSE_CLIENT = ''; // e.g. 'ca-pub-XXXXXXXXXXXXXXXX' (1099estimator's own)
